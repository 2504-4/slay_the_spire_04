...
public class GameModel {
    ...
    // ==================== 奖励卡牌 ====================
    public class IronSlashCard extends Card {
        public IronSlashCard() {
            super("铁斩波", "造成 7 点伤害，获得 7 点格挡", 1, CardType.ATTACK);
        }
    ...
    public class HeavyHammerCard extends Card {
        public HeavyHammerCard() {
            super("重锤", "造成 24 点伤害", 2, CardType.ATTACK);
        }
    ...
    public class WallCard extends Card {
        public WallCard() {
            super("城墙", "获得 20 点格挡", 2, CardType.SKILL);
        }
    ...
    public class UltimateStrikeCard extends Card {
        public UltimateStrikeCard() {
            super("究极打击", "造成 10 点伤害", 1, CardType.ATTACK);
        }
    ...
    public class UltimateDefendCard extends Card {
        public UltimateDefendCard() {
            super("究极防御", "获得 8 点格挡", 1, CardType.SKILL);
        }
    ...
    public class Player {
        ...
        /**
         * 新关卡开始前重整牌堆：所有卡牌洗回抽牌堆，弃牌堆保持为空。
         * 随后的 startTurn() 会从这个完整牌堆中抽取新关卡的起始手牌。
         */
